package br.com.realizecfi.reciclagem.utils;
...
public final class RandomCollectionUtils {
    ...
    public static <T> List<T> generateList(final Supplier<T> supplier, final int startInclusive, final int endExclusive) {
